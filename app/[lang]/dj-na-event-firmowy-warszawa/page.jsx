...
const CONTENT = {
  pl: {
    ...
    benefits: [
      ...
      { num: '03', title: 'Dyskretny background lub energetyczny parkiet', desc: 'Od muzyki w tle podczas przyjęcia i kolacji po pełną imprezę na zakończenie wieczoru.' },
      { num: '04', title: 'Sprzęt klasy pro', desc: 'Pioneer DJ CDJ-3000 + DJM-A9. Dostępny jest też wynajem sprzętu.' },
    ...
    faq: [
      ...
      { q: 'Czy przywozisz własny sprzęt?', a: 'Tak — Pioneer DJ CDJ-3000 + DJM-A9. Dostępny jest też wynajem sprzętu.' },
  ...
  en: {
    ...
    benefits: [
      ...
      { num: '04', title: 'Pro-grade equipment', desc: 'Pioneer DJ CDJ-3000 + DJM-A9. Equipment rental also available.' },
    ...
    faq: [
      ...
      { q: 'Do you travel outside Warsaw for corporate events?', a: 'Yes. I\'m based in Warsaw but perform across Poland and internationally. Travel logistics are agreed individually.' },
    ],
  ...
  ru: {
    ...
    benefits: [
      ...
      { num: '04', title: 'Профессиональное оборудование', desc: 'Pioneer DJ CDJ-3000 + DJM-A9. Также доступна аренда оборудования.' },
    ...
    faq: [
      ...
      { q: 'Привозите своё оборудование?', a: 'Да — Pioneer DJ CDJ-3000 + DJM-A9. Также доступна аренда оборудования.' },
      { q: 'Работаете за пределами Варшавы?', a: 'Да. Базируюсь в Варшаве, работаю по всей Польше и выезжаю за рубеж. Логистику согласовываем индивидуально.' },
    ],
