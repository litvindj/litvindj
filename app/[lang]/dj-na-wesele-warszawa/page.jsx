...
const CONTENT = {
  ...
  en: {
    ...
    faq: [
      ...
      { q: 'Do you travel outside Warsaw for weddings?', a: 'Yes. I\'m based in Warsaw but perform across Poland and throughout Europe. Travel details are agreed individually.' },
  ...
  ru: {
    ...
    benefits: [
      ...
      { num: '05', title: 'Польша и вся Европа', desc: 'Базируюсь в Варшаве, работаю по всей Польше и выезжаю в Европу.' },
    ],
    ...
    faq: [
      ...
      { q: 'Работаете за пределами Варшавы?', a: 'Да. Базируюсь в Варшаве, работаю по всей Польше и выезжаю в Европу. Детали логистики согласовываем индивидуально.' },
