...
const CONTENT = {
  pl: {
    ...
    benefitsLabel: 'Dlaczego DJ Litvin',
    benefits: [
      ...
      { num: '02', title: 'Własny sprzęt klasy pro', desc: 'Pioneer DJ CDJ-3000, DJM-A9. Dostępny jest też wynajem sprzętu.' },
      ...
      { num: '05', title: 'Dostępny w Polsce i za granicą', desc: 'Gram w Warszawie, ale obsługuję całą Polskę i wyjeżdżam za granicę. Logistyka i sprzęt — moja sprawa.' },
    ],
    ...
    faq: [
      ...
      { q: 'Czy przyjeżdżasz z własnym sprzętem?', a: 'Tak — Pioneer DJ CDJ-3000 + DJM-A9. Dostępny jest też wynajem sprzętu.' },
      { q: 'Jak daleko dojeżdżasz na wesele?', a: 'Gram w Warszawie, ale obsługuję całą Polskę i wyjeżdżam za granicę. Dojazd i logistykę ustalamy indywidualnie.' },
  ...
  en: {
    ...
    benefits: [
      ...
      { num: '02', title: 'Pro-grade equipment', desc: 'Pioneer DJ CDJ-3000 + DJM-A9. Equipment rental also available.' },
      ...
      { num: '05', title: 'Available across Poland and internationally', desc: 'Based in Warsaw, but available across Poland and internationally. Travel logistics are handled on my end.' },
    ],
    ...
    faq: [
      ...
      { q: 'Do you bring your own equipment?', a: 'Yes — Pioneer DJ CDJ-3000 + DJM-A9. Equipment rental also available.' },
      { q: 'Do you travel outside Warsaw for weddings?', a: 'Yes. I\'m based in Warsaw but perform across Poland and internationally. Travel details are agreed individually.' },
  ...
  ru: {
    ...
    benefits: [
      ...
      { num: '02', title: 'Профессиональное оборудование', desc: 'Pioneer DJ CDJ-3000 + DJM-A9. Также доступна аренда оборудования.' },
      ...
      { num: '05', title: 'Польша и другие страны', desc: 'Базируюсь в Варшаве, работаю по всей Польше и выезжаю за рубеж.' },
    ],
    ...
    faq: [
      ...
      { q: 'Вы привозите своё оборудование?', a: 'Да — Pioneer DJ CDJ-3000 + DJM-A9. Также доступна аренда оборудования.' },
      { q: 'Работаете за пределами Варшавы?', a: 'Да. Базируюсь в Варшаве, работаю по всей Польше и выезжаю за рубеж. Детали логистики согласовываем индивидуально.' },
